...
import argparse
import main.mapping
from main import util_tools, process_file_b, process_folder_b, process_folder_c
...
def create_asset_json(*args):  # args: ['file' / 'dir'], [path], [mapping], [csv files], [env name], [version]
    ...
    # process folder
        ...
        result = process_folder_c.process_folder(file_folder, path, mapping, csv_file, env_name, ver)
    print(f'{cgreen}----------------------------------------------------{cend}')
